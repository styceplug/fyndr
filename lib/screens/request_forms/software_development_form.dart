...
import 'package:fyndr/data/services/software_data.dart';
...
class SoftwareDevelopmentForm extends StatefulWidget {
  const SoftwareDevelopmentForm({super.key});

  @override
  State<SoftwareDevelopmentForm> createState() => _SoftwareDevelopmentFormState();
}

class _SoftwareDevelopmentFormState extends State<SoftwareDevelopmentForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:  CustomAppbar(
        customTitle: Text('Post a Software Development Request'),
        centerTitle: true,
