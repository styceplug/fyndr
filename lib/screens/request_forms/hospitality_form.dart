...
class HospitalityForm extends StatefulWidget {
  const HospitalityForm({super.key});
...
class _HospitalityFormState extends State<HospitalityForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:  CustomAppbar(
        customTitle: Text('Post a Hospitality Request'),
        centerTitle: true,
        leadingIcon: BackButton(color: Theme.of(context).dividerColor),
        subtitle: 'Hotel, Short let apartment, Travel Agency, Fitness centre, Spa and more',
      ),
